<template>
  <div class="leftSideLayout col-lg-2 col-sm-12">
    <div class="leftSideWrapper col-12 d-flex flex-column">
      <div class="top-sidebar mb-5">
        ...
        <div class="sidebarLinks d-flex justify-content-center mt-2">
          <ul
        ...
        <div class="socialIcons d-flex justify-content-center mt-3">
