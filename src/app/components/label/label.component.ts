...
export class LabelComponent {
    ...
    @Input() labelClass: string =
        'dark:bg-custom-purple-100 dark:text-custom-grey-200 dark:hover:bg-custom-yellow-500 dark:hover:text-custom-purple-900 bg-custom-blue-400 text-custom-yellow-500 hover:bg-custom-blue-600 hover:text-white hover:font-bold dark:hover:font-bold';
