export const site = {
  ...
  linkedin: 'https://www.linkedin.com/in/hossein13m',
  stackoverflow: 'https://stackoverflow.com/users/10341207/hossein-mousavi',
  medium: 'https://hossein13m.medium.com/',
  telegram: 'https://t.me/DevDastan',
} as const;
