<template>
  <div class="story">
    <div class="top-contact justify-content-center">
      <h1 class="text-center pt-5 font-weight-light">My Story!</h1>
    </div>
    <hr />
    <div class="animated bounceInUp container mx-auto story mt-5 mr-5">
      <p>
      ...
      <p>
        I have also begun to write and share my little knowledge in Medium and
        Virgool which you can follow me.
        I also contribute to StackOverflow.
      </p>
      <p
        class="mb-0 pb-5"
